                               ...
                               <ul id="menu" >
                                   ...
                                   <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i>  <span>Документы</span> <span class="fa fa-angle-right pull-right"></span><div class="clearfix"></div></a>
                                       <ul id="menu-academico-sub" >
                                           <li id="menu-academico-boletim" ><a href="/main/energy/billing/calculate">Расчет потребления</a></li>
                                           <li id="menu-academico-avaliacoes" ><a href="/main/energy/billing/renter-calculate">Расчет по арендатору</a></li>
                                       </ul>
                                   </li>
